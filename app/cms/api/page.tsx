      ...
      "X-Auth-Key": API_KEY,
            ...
            <div className="flex flex-col justify-center items-start w-full gap-3">
              ...
              <pre className="bg-gray-950 dark:bg-zinc-900 p-4 rounded-md max-w-[600px]">
                <code className="text-gray-50 dark:text-white font-mono">
                  {`const response = await fetch(
  \`\https://Zain.xyz/api/blog/all/[site_id]\`,
  {
    headers: {
      "X-Auth-Key": API_KEY,
    },
      ...
      "X-Auth-Key": API_KEY,
            ...
            <div className="flex flex-col justify-center items-start w-full gap-3">
              ...
              <pre className="bg-gray-950 dark:bg-zinc-900 p-4 rounded-md max-w-[600px]">
                <code className="text-gray-50 dark:text-white font-mono">
                  {`const response = await fetch(
  \`\https://Zain.xyz/api/blog/slugs/[site_id]\`,
  {
    headers: {
      "X-Auth-Key": API_KEY,
    },
            ...
            <div className="flex flex-col justify-center items-start w-full gap-3">
              ...
              <pre className="bg-gray-950 dark:bg-zinc-900 p-4 rounded-md max-w-[600px]">
                <code className="text-gray-50 dark:text-white font-mono">
                  {`const response = await fetch(
  \`\https://Zain.xyz/api/blog/[site_id]/[slug]\`,
  {
    method: "POST",
    headers: {
      "X-Auth-Key": API_KEY,
